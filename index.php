...
?>
	...
	<img src="img/beach.jpg" /><br / >
			<form id="list" method="get" action="">
				...
				step="1000" name="budget" min="0" max="5000" list="steplist" value="0" 
				onchange="document.getElementById('budgetValue').innerHTML = this.value;">
				
				</input>$5000</p>

				<button id="budgetValue" style="font-size:1.5em;"
				onclick="top.location.href = 'packages.php?budget='+document.getElementById('budgetValue').innerHTML"></button>
